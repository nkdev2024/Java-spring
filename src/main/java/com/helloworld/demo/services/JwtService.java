...
public class JwtService {
    ...
    public Boolean validateToken(String token, BodyData userDetails) {
        final String firstName = extractUsername(token);
        return (firstName.equals(userDetails.getFirstName()) && !isTokenExpired(token));
    }
    ...
    private String createToken(Map<String, Object> claims, String firstName) {
